...
def upgrade() -> None:
    ...
    op.create_table(
        'celery_tasks', sa.Column('id', sa.Uuid(), nullable=False), sa.Column('task_name', sa.String(), nullable=False), sa.PrimaryKeyConstraint('task_name')
    )
    op.create_table(
        'points',
        ...
        sa.UniqueConstraint('address', 'city', name='city_address_unique'),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('worker_id', 'date'),
    )
